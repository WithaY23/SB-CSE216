...
/**
 * Test case provided by professor:
...
//        verified
        ...
        //personal test code
        Square s4 = s1.rotateBy(120);

        System.out.println("Rotated symmetry: " + squareSymmetries.areSymmetric(s2,s4)); //true

        Square s5 = s1.translateBy(1,2);
        System.out.println("Translated identity: " + squareSymmetries.areSymmetric(s1,s5)); //false

        Square s6 = squareSymmetries.diagonalReflection(squareSymmetries.verticalReflection(s1).rotateBy(90)).translateBy(1,2);
        System.out.println("Translated symmetry: " + squareSymmetries.areSymmetric(s5,s6)); //true
